...
const CoordinatorSettings: React.FC = () => {
    ...
    return (
        <DashboardLayout role="coordinator" userName={localStorage.getItem('userName') || 'Coordinator'}>
            <div className="max-w-md mx-auto mt-10 bg-white p-8 rounded shadow">
                <h2 className="text-2xl font-bold mb-6 text-gray-800">Coordinator Settings</h2>
